...
const cardsData = [
  {
    title: 'Расписать тренировки', icon: <HeartFilled twoToneColor='var(--color-Blue)' style={{ fontSize: '12px' }} />, subtitle: 'Тренировки'
  },
  { title: 'Назначить календарь', icon: <CalendarTwoTone style={{ fontSize: '12px' }} twoToneColor='var(--color-Blue)' />, subtitle: 'Календарь' },
  { title: 'Заполнить профиль', icon: <IdcardOutlined style={{ fontSize: '12px' }} twoToneColor='var(--color-Blue)' />, subtitle: 'Профиль' },
];
